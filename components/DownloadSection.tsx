...
export default function DownloadSection() {
  ...
  const installationSteps = {
    ...
    mac: {
      ...
      commands: [
        '# Extract the zip file',
        'unzip local-ai-chat-mac.zip',
        'cd local-ai-chat-mac',
        '',
        '# Install Ollama (if not already installed)',
        '# Download from: https://ollama.ai',
        '',
        ...
        'chmod +x "START CHAT (Mac).command"',
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-8 md:space-y-12 pb-12 md:pb-20 select-none px-4 md:px-0" data-section="getting-started">
